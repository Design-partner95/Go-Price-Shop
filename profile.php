...
<head>
	<title>User Profile | DiffDash - Free Admin Template</title>
	<meta charset="utf-8">
			...
			<div class="sidebar-scroll">
				...
				<nav id="left-sidebar-nav" class="sidebar-nav">
					<ul id="main-menu" class="metismenu">
						...
						<li class="active">
							<a href="#subPages" class="has-arrow" aria-expanded="true"><i class="lnr lnr-file-empty"></i> <span>Pages</span></a>
							<ul aria-expanded="true">
								<li class="active"><a href="page-profile.html">User Profile</a></li>
